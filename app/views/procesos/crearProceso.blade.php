          ...
          <div style="margin-left:30px">
                 ...
                 <tbody>
                    ...
                    <td name="ddiv" align="center">
                         @if (Session::has('errorCrearProceso'))
                    ...
                    <table align="center">
	                 <tbody>
	                 <tr>                    
               {{ Form::open(array('action' => 'procesoController@store', 'files' => true)) }}
		            ...
		            <td style="padding:15px">
                         <textarea name="descripcionProceso" class="form-control" rows="5" cols="50">
