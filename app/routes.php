...
//Ruta para mostrar los procesos instancia que estan en ejecucuion o terminados del administrador
Route::get('/procesos/instancia/admin/{id}', array('uses' => 'procesoController@instanciasProcesosAdmin'));

//Ruta para mostrar los procesos instancia que estan en ejecucuion o terminados de la bandeja
